...
const FriendRequestsSidebarOption: FC<FriendRequestsSidebarOptionProps> = ({ sessionId, initialUnseenRequestCount }) => {
  ...
  return (
    ...
    >
      <div className="text-gray-400 border-gray-200 group-hover>text-indigo-600 flex h-6 w-6 shrink-0 item-center justify-center rounded-lg border text-[0.625rem] font-medium bg-white">
